...
from utilities.page_utility import Page_Utility
...
#        self.driver.find_element(*self.admin_tile_locator).click()
    ...
    def enter_admin_users_information(self):
        ...
        self.page_utility.staff_select(user_type_dropdown) #func. from utilities.page_utility
